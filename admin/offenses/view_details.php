...
if(isset($_GET['id']) && $_GET['id'] > 0){
    $qry = $conn->query("SELECT r.*,d.age, d.name as driver from `offense_list` r inner join `drivers_list` d on r.driver_id = d.id where r.id = '{$_GET['id']}' ");
    if($conn->error){
        echo $conn->error ."\n";
        echo "SELECT r.*,d.age, d.name as driver from `offense_list` r inner join `drivers_list` on r.driver_id = d.id where r.id = '{$_GET['id']}' ";
    }
    ...
    <style>
        ...
        <table class="table boder-0">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="d-flex w-max-100">
                                ...
                                <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $age ?></b></p>
                            </div>
                            <div class="d-flex w-max-100">
            ...
            <tr>
                <td colspan='2'>
                    <div class="d-flex w-max-100">
                        <label class="float-left w-auto whitespace-nowrap">Prone Places/Street Name:</label>
                        <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $prone_places ?></b></p>
                    </div>
                    <div class="d-flex w-max-100">
