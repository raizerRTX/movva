        ...
        <div class="container-fluid" id="print_out">
			<table class="table table-hover table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT r.*,d.age FROM `offense_list` r inner join `drivers_list` d on r.driver_id = d.id where date(r.date_created) between '{$date_start}' and '{$date_end}' order by unix_timestamp(r.date_created) desc ");
