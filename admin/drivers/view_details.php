                        ...
                        <div class="col-12">
                            ...
                            <div class="row justify-content-between  w-max-100">
                                <div class="col-6 d-flex w-max-100">
                                    ...
                                    <p class="col-md-auto border-bottom px-2 border-dark w-100"><b><?php echo $sex ?></b></p>
                                </div>
                                <div class="col-6 d-flex w-max-100">
                                    <label class="float-left w-auto whitespace-nowrap">age: </label>
                                    <p class="col-md-auto border-bottom px-2 border-dark w-100"><b><?php echo $age ?></b></p>
                                </div>
                            </div>
                            <div class="d-flex w-max-100">
                                <label class="float-left w-auto whitespace-nowrap">Present City:</label>
                                <p class="col-md-auto border-bottom border-dark w-100"><b><?php echo $present_city ?></b></p>
                            </div>
                            <div class="d-flex w-max-100">
